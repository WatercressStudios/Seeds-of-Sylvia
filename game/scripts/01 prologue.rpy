label prologue:
    ...
    anr "Apples. Onions. Potatoes. Pumpkins." 

    anr "These are just a fraction of the crops we have by the grace of honeybees." 

    anr "In the recent past, one in three meals eaten by humans existed through the pollination of bees—but this year, reports indicate that number may have fallen to one in thirty."

    anr "Those of us here at WCPR have been reporting for years on the steady and haunting decline of bees. Myriad efforts to halt or even slow the mysterious tide of Colony Collapse Disorder have failed, and today the crisis seems more dire than ever. Honeybee populations have become completely extirpated from ninety-eight percent of North America, and numbers are similar across all continents. In the absence of pollinators, several species of plants have already gone extinct."
    ...
    dor "Well, we’ve wasted much too much time already—the term ‘Colony Collapse Disorder’ was coined in 2006, and in twenty years of research there’s still no scientific consensus on what even {i}causes{/i} it, much less how to counteract it. Parasites, toxic fungi, viruses, nicotinoids—these have all been hugely destructive to the species, but still only a piece of the puzzle, and at the rate bees are disappearing, we have only about a year to eighteen months to solve the problem."
 
    dor "We’ve had the best scientific minds on this problem for three decades. Even with additional funding, it seems unlikely we’ll figure out how to save the bees while there are still bees to save."
 
    anr "But while there are still living bees on the planet, why would it be bad just to try?"
 
    dor "There are indeed still living bees, certainly, but the sad reality is that we don’t even know where most of them {i}are{/i}. Most of the remaining one percent of living honeybees is {i}missing{/i}. They’re lost somewhere in the wilderness, if they even exist at all. And while we’re wasting time, manpower and resources trying to find them, human beings are starving."
 
    anr "You’ve been saying that we should just ignore the problem? Pull the funding and let the bees go extinct?"
 
    dor "Heavens, no. I absolutely believe an effort of this scale is necessary—but we’re visualizing the problem the working way. This is a lost cause; too much damage has already been done. The loss of the honeybees is disturbing and sad, and probably could have been avoided, but it’s far too late—and unfortunately our decision-makers in government and most of the leading scientific experts are looking at the situation with a sort of myopia."
 
    nvl clear

    dor "I will give you the straight truth, Takara. The bees are lost—but that doesn’t mean our food supply is, too. We need to be leveraging these resources to explore alternate means of crop pollination."
    ...
    dor "Absolutely. The solution is modern technology, Takara. We need to build a better bee. Tiny robots—in the books I call them synthbees, but in truth they probably won’t look anything like honeybees—with complete immunity to pesticides, viruses or parasites, will pollinate our crops. Nobody will have to starve."
