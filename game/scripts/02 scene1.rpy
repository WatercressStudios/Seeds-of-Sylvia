label scene1:
    ...
    "Sibyl protests my disruption of her entertainment from her chair.  I retort from behind her."

    ash "And I {i}wasn't{/i}.  We're here to save the bees, not postulate how best to replace them. I might {i}also{/i} remind you that we're on the clock."
    ...
    sib "You've circled some trees, I see."

    ash "How very observant. But we're talking about the bigger picture. This entire area's full of low level foliage. Shrubs, relatively young trees, common plants for a common place. But this, this spot here, is denser by an order of magnitude. Trees that double the height of any in the surrounding area. Growth like that takes time, Sibyl. This forest has been around for centuries, and why?"
    ...
    "I struggle to stop myself from gritting my teeth."

    ash "{i}Because{/i} it is a focal point. Bigger than any I've seen. Hyper-fertile land, fed by a veritable fountain of natural energy! I'm betting the farms around here are incredibly lucrative."
