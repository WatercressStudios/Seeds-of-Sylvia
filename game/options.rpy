...
init -1 python hide:
    ...
    config.window_title = u"Seeds of Sylvia"

    ## These control the name and version of the game, that are reported
    ## with tracebacks and other debugging logs.
    config.name = "Seeds of Sylvia"
    config.version = "1.0"
    ...
    config.main_menu_music = "music/83.ogg"
    ...
    config.after_load_transition = blinds
...
python early:
    config.save_directory = "Turnip-1450744908"
...
init python:
    ...
    build.directory_name = "SeedsofSylvia-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "SeedsofSylvia"
